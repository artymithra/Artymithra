...
import FlowingFrame from "../../Images/Flowingcanvas.png";
...
const images = [FlowingFrame, FlowingFrame];

export default function FlowingArtFrame() {
  ...
  const product = {
    id: "frame-003",
    productCode: "FlowingDoodle-Canva-Frame-003",
    name: "Flowing Doodle Art Canva Frame",
    price: 1000,
    image: FlowingFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Canva Frame</p>

            <h2 className="fw-bold">Flowing Doodle Art Pattern Canva Frame</h2>
