...
import FlowingTshirt from "../../Images/FlowingTshirt.png";
...
const images = [FlowingTshirt, FlowingTshirt];

export default function FlowingArtTshirt() {
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Tshirt
            </h2>
