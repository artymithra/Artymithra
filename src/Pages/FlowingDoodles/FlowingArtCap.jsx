...
import FlowingCap from "../../Images/FlowingCap.png";
...
const images = [FlowingCap, FlowingCap];

export default function FlowingArtCap() {
  ...
  const product = {
    id: "cap-003",                 
    productCode: "FlowingDoodleArt-Cap-003",
    name: "Flowing Doodle Art Pattern Cap",
    price: 1400,
    image: FlowingCap,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Cap
            </h2>
