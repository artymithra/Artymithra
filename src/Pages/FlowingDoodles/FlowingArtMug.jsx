...
import FlowingMug from "../../Images/FlowingMug.png";
...
const images = [FlowingMug, FlowingMug];

export default function FlowingArtMug() {
  ...
  const product = {
    id: "mug-003",                 
    productCode: "FlowingDoodleArt-Mug-003",
    name: "Flowing Doodle Art Pattern Ceramic Mug",
    price: 1400,
    image: FlowingMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
