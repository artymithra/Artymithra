...
import FlowingCup from "../../Images/FlowingCup.png";
...
const images = [FlowingCup, FlowingCup];

export default function FlowingArtCup() {
  ...
  const product = {
    id: "cup-003",                 
    productCode: "FlowingDoodleArt-CoffeeCup-003",
    name: "Flowing Doodle Art Pattern Cup",
    price: 1400,
    image: FlowingCup,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Coffee Cup
            </h2>
