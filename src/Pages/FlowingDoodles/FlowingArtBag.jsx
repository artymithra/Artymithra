...
import FlowingBag from "../../Images/FlowingBag.png";
...
const images = [FlowingBag, FlowingBag];

export default function FlowingArtBag() {
  ...
  const product = {
    id: "Bag-003",                 
    productCode: "FlowingDoodleArt-Bag-003",
    name: "Flowing Doodle Art Pattern Bag",
    price: 600,
    image: FlowingBag,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Bag
            </h2>
