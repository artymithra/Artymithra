...
import FlowingBottle from "../../Images/FlowingBottle.png";
...
const images = [FlowingBottle, FlowingBottle];

export default function FlowingArtBottle() {
  ...
  const product = {
    id: "Bottle-003",                 
    productCode: "FlowingDoodleArt-Bottle-003",
    name: "Flowing Doodle Art Pattern Bottle",
    price: 1400,
    image: FlowingBottle,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Flowing Doodle Art Pattern Bottle
            </h2>
