...
import KantaraBag from "../../Images/KantaraBag.png";
...
const images = [KantaraBag, KantaraBag];

export default function KantaraArtBag() {
  ...
  const product = {
    id: "bag-010",                 
    productCode: "KantaraArt-Bag-010",
    name: "Kantara Art Bag",
    price: 1000,
    image: KantaraBag,
  };
