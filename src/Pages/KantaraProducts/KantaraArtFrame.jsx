...
import KantaraFrame from "../../Images/Kantaracanvas.png";
...
const images = [KantaraFrame, KantaraFrame];

export default function KantaraArtFrame() {
  ...
  const product = {
    id: "frame-010",                 
    productCode: "KantaraArt-Canva-Frame-010",
    name: "Kantara Art Canva Frame",
    price: 1000,
    image: KantaraFrame,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Kantara Art Pattern Canva Frame
            </h2>
