...
import KantaraTshirt from "../../Images/Kantaratshirt.png";
...
const images = [KantaraTshirt, KantaraTshirt];

export default function KantaraArtTshirt() {
  ...
  const product = {
    id: "Tshirt-010",                 
    productCode: "Kantara-Tshirt-010",
    name: "Kantara Art Tshirt",
    price: 600,
    image: KantaraTshirt,
  };
