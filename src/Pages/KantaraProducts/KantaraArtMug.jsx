...
import KantaraMug from "../../Images/Kantaramug.png";
...
const images = [KantaraMug, KantaraMug];

export default function KantaraArtMug() {
  ...
  const product = {
    id: "mug-010",                 
    productCode: "KantaraArt-Mug-010",
    name: "Kantara Art Mug",
    price: 600,
    image: KantaraMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Kantara Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
