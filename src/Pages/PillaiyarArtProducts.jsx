...
export default function PillaiyarArtProducts() {
            ...
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  ...
                  onClick={() => navigate("/pillaiyar-products/tshirt")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/pillaiyar-products/bag")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/pillaiyar-products/mug")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/pillaiyar-products/frame")}
                >
                  Select Product
                </button>
              </Card.Body>
           ...
           <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/pillaiyar-products/lamp")}
                >
                  Select Product
                </button>
              </Card.Body>
