...
import MickeyFrame from "../../Images/Mickeymousecanvas.png";
...
const images = [MickeyFrame, MickeyFrame];

export default function MickeyArtFrame() {
  ...
  const product = {
    id: "frame-004",
    productCode: "MickeyMouseArt-Canva-Frame-004",
    name: "Mickey Mouse Art Canva Frame",
    price: 1000,
    image: MickeyFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Mickey Mouse Art Canva Frame </h2>
