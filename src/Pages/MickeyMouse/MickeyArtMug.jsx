...
import MickeyMug from "../../Images/MickeyMug.png";
...
const images = [MickeyMug, MickeyMug];

export default function MickeyArtMug() {
  ...
  const product = {
    id: "mug-004",                 
    productCode: "MickeyMouseArt-Mug-004",
    name: "Mickey Mouse Art Pattern Ceramic Mug",
    price: 1400,
    image: MickeyMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Mickey Mouse Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
