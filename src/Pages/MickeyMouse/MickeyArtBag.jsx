...
import MickeyBag from "../../Images/MickeyBag.png";
...
const images = [MickeyBag, MickeyBag];

export default function MickeyArtBag() {
  ...
  const product = {
    id: "bag-004",                 
    productCode: "MickeyMouseArt-Bag-004",
    name: "Mickey Mouse Art Bag",
    price: 1400,
    image: MickeyBag,
  };
