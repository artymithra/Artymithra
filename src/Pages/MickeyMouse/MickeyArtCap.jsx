...
import MickeyCap from "../../Images/MickeyCap.png";
...
const images = [MickeyCap, MickeyCap];

export default function MickeyArtCap() {
  ...
  const product = {
    id: "cap-004",                 
    productCode: "MickeyMouseArt-cap-004",
    name: "Mickey Mouse Art Pattern Cap",
    price: 1400,
    image: MickeyCap,
  };
