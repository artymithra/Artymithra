...
import MickeyBottle from "../../Images/MickeyBottle.png";
...
const images = [MickeyBottle, MickeyBottle];

export default function MickeyArtBottle() {
  ...
  const product = {
    id: "bottle-004",                 
    productCode: "MickeyMouseArt-Bottle-004",
    name: "Mickey Mouse Art Bottle",
    price: 1400,
    image: MickeyBottle,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Mickey Mouse Art Pattern Bottle
            </h2>
