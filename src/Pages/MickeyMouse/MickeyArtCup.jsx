...
import MickeyCup from "../../Images/MickeyCup.png";
...
const images = [MickeyCup, MickeyCup];

export default function MickeyArtCup() {
  ...
  const product = {
    id: "cup-004",                 
    productCode: "MickeyMouseArt-CoffeeCup-004",
    name: "Mickey Mouse Art Pattern Cup",
    price: 1400,
    image: MickeyCup,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Mickey Mouse Art Pattern Coffee Cup
            </h2>
