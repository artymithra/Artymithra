...
export default function MickeyMouseArtProducts() {
            ...
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  ...
                  onClick={() => navigate("/mickeyMouse-products/bottle")}
                >
                  {" "}
                  Select Product
                </button>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/mickeyMouse-products/cap")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/mickeyMouse-products/cup")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/mickeyMouse-products/tshirt")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/mickeyMouse-products/bag")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/mickeyMouse-products/mug")}
                >
                  Select Product
                </button>
              </Card.Body>
