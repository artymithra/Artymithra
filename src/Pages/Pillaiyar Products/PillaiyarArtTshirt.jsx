...
import PillaiyarTshirt from "../../Images/Pillaiyartshirt.png";
...
const images = [PillaiyarTshirt, PillaiyarTshirt];

export default function PillaiyarArtTshirt() {
  ...
  const product = {
    id: "tshirt-008",                 
    productCode: "PillaiyarArt-Tshirt-008",
    name: "Pillaiyar Art Tshirt",
    price: 600,
    image: PillaiyarTshirt,
  };
