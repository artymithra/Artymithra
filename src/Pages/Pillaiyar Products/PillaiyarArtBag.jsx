...
import PilliyarBag from "../../Images/PillaiyarBag.png";
...
const images = [PilliyarBag, PilliyarBag];

export default function PillaiyarArtBag() {
  ...
  const product = {
    id: "bag-008",                 
    productCode: "PullaiyarArt-Bag-008",
    name: "Pullaiyar Art Bag",
    price: 1000,
    image: PilliyarBag,
  };
