...
import PillaiyarMug from "../../Images/PillaiyarMug.png";
...
const images = [PillaiyarMug, PillaiyarMug];

export default function PillaiyarArtMug() {
  ...
  const product = {
    id: "mug-008",                 
    productCode: "Pillaiyar-Mug-008",
    name: "Pillaiyar Art Mug",
    price: 600,
    image: PillaiyarMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Pillaiyar Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
