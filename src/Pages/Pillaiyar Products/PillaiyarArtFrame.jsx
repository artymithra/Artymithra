...
import PillaiyarFrame from "../../Images/Pillaiyarcanvas.png";
...
const images = [PillaiyarFrame, PillaiyarFrame];

export default function PillaiyarArtFrame() {
  ...
  const product = {
    id: "frame-008",                 
    productCode: "PillaiyarArt-Canva-Frame-008",
    name: "Pillaiyar Art Canva Frame",
    price: 1000,
    image: PillaiyarFrame,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Pillaiyar Art Pattern Canva Frame
            </h2>
