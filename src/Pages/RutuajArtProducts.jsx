...
export default function RutuajArtProducts() {
            ...
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  ...
                  onClick={() => navigate("/ruturaj-products/tshirt")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/ruturaj-products/bag")}
                >
                  Select Product
                </button>
              </Card.Body>
          ...
          <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/ruturaj-products/mug")}
                >
                  Select Product
                </button>
              </Card.Body>
           ...
           <div className="col-12 col-lg-4 mb-4">
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/ruturaj-products/frame")}
                >
                  Select Product
                </button>
              </Card.Body>
            ...
            <Card className="border border-2 border-mutted">
              ...
              <Card.Body>
                ...
                <button
                  className="Selectdesignbutton p-2"
                  onClick={() => navigate("/ruturaj-products/lamp")}
                >
                  Select Product
                </button>
              </Card.Body>
