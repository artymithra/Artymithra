...
import RamarTshirt from "../../Images/Ramartshirt.png";
...
const images = [RamarTshirt, RamarTshirt];

export default function RamarArtTshirt() {
  ...
  const product = {
    id: "tshirt-007",                 
    productCode: "RamarArt-Tshirt-007",
    name: "Ramar Art Tshirt",
    price: 600,
    image: RamarTshirt,
  };
