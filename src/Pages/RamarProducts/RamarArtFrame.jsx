...
import RamarFrame from "../../Images/Ramarcanvas.png";
...
const images = [RamarFrame, RamarFrame];

export default function RamarArtFrame() {
  ...
  const product = {
    id: "frame-007",                 
    productCode: "RamarArt-Canva-Frame-007",
    name: "Ramar Art Canva Frame",
    price: 1000,
    image: RamarFrame,
  };
