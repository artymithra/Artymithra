...
import RamarLamp from "../../Images/Ramarlamp.png";
...
const images = [RamarLamp, RamarLamp];
const MIN_QTY = 25;

export default function RamarArtLamp() {
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Ramar Art Pattern Lamp</h2>
