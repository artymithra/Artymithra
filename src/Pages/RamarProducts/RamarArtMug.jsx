...
import RammarMug from "../../Images/RammarMug.png";
...
const images = [RammarMug, RammarMug];

export default function RamarArtMug() {
  ...
  const product = {
    id: "mug-007",                 
    productCode: "RamarArt-Mug-007",
    name: "RamarArt Art Mug",
    price: 600,
    image: RammarMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Ramar Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
