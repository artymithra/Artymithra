...
import GirlRainBag from "../../Images/GirlrainBag.png";
...
const images = [GirlRainBag, GirlRainBag];

export default function GirlRainArtBag() {
  ...
  const product = {
    id: "bag-012",                 
    productCode: "GirlInRainArt-Bag-012",
    name: "Girl In Rain Art Bag",
    price: 1000,
    image: GirlRainBag,
  };
