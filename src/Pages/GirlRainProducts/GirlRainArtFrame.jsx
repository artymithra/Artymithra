...
import GirlRainFrame from "../../Images/GirlrainCanvas.png";
...
const images = [GirlRainFrame, GirlRainFrame];

export default function GirlRainArtFrame() {
  ...
  const product = {
    id: "frame-012",                 
    productCode: "GirlInRainArt-Canva-Frame-012",
    name: "Girl In Rain Art Canva Frame",
    price: 1000,
    image: GirlRainFrame,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Girl In Rain Art Pattern Canva Frame
            </h2>
