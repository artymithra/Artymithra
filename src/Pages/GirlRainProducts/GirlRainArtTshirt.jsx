...
import GirlRainTshirt from "../../Images/Girlraintshirt.png";
...
const images = [GirlRainTshirt, GirlRainTshirt];

export default function GirlRainArtTshirt() {
  ...
  const product = {
    id: "Tshirt-012",                 
    productCode: "GirlInRainArt-Tshirt-012",
    name: "Girl In Rain Art Tshirt",
    price: 600,
    image: GirlRainTshirt,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Girl In Rain Art Pattern Tshirt
            </h2>
