...
import GirlRainMug from "../../Images/Girlrainmug.png";
...
const images = [GirlRainMug, GirlRainMug];

export default function GirlRainArtMug() {
  ...
  const product = {
    id: "mug-012",                 
    productCode: "GirlInRainArt-Mug-012",
    name: "Girl In Rain Art Mug",
    price: 600,
    image: GirlRainMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Girl In Rain Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
