...
import ElegantCap from "../../Images/ElegantCap.png";
...
const images = [ElegantCap, ElegantCap];

export default function ElegantArtCap() {
  ...
  const product = {
    id: "cap-006",                 
    productCode: "ElegantArt-Cap-006",
    name: "Elegant Art Cap",
    price: 1400,
    image: ElegantCap,
  };
