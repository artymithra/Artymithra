...
import ElegantFrame from "../../Images/Elegantcanvas.png";
...
const images = [ElegantFrame, ElegantFrame];

export default function ElegantArtFrame() {
  ...
  const product = {
    id: "frame-006",
    productCode: "ElegantArt-Canva-Frame-006",
    name: "Elegant  Art Canva Frame",
    price: 1000,
    image: ElegantFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Elegant Art Pattern Canva Frame</h2>
