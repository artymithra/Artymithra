...
import ElegantBag from "../../Images/ElegantBag.png";
...
const images = [ElegantBag, ElegantBag];

export default function ElegantArtBag() {
  ...
  const product = {
    id: "Bag-006",                 
    productCode: "ElegantArt-Bag-006",
    name: "Elegant Art Bag",
    price: 1400,
    image: ElegantBag,
  };
