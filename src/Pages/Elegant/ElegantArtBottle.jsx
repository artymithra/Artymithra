...
import ElegantBottle from "../../Images/ElegantBottle.png";
...
const images = [ElegantBottle, ElegantBottle];

export default function ElegantArtBottle() {
  ...
  const product = {
    id: "bottle-006",                 
    productCode: "ElegantArt-Bottle-006",
    name: "Elegant Art Bottle",
    price: 1400,
    image: ElegantBottle,
  };
