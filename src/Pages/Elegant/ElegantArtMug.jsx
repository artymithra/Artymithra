...
import ElegantMug from "../../Images/ElegantMug.png";
...
const images = [ElegantMug, ElegantMug];

export default function ElegantArtMug() {
  ...
  const product = {
    id: "mug-006",                 
    productCode: "ElegantArt-Mug-006",
    name: "Elegant Art Mug",
    price: 600,
    image: ElegantMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Elegant Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
