...
import ElegantCup from "../../Images/ElegantCup.png";
...
const images = [ElegantCup, ElegantCup];

export default function ElegantArtCup() {
  ...
  const product = {
    id: "coffeeCup-006",                 
    productCode: "ElegantArt-CoffeeCup-006",
    name: "Elegant Art Coffee Cup",
    price: 1400,
    image: ElegantCup,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Elegant Art Pattern Coffee Cup
            </h2>
