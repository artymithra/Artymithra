...
import ElegantTshirt from "../../Images/ElegantTshirt.png";
...
const images = [ElegantTshirt, ElegantTshirt];

export default function ElegantArtTshirt() {
