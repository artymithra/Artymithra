...
import GirlCupImage from "../../Images/GirlCup.png";
...
const images = [GirlCupImage, GirlCupImage];

export default function GirlArtCup() {
  ...
  const product = {
    id: "coffeecup-002",                 // internal (React/cart)
    productCode: "GirlArt-CoffeeCup-002", // business tracking (backend)
    name: "Girl Art Pattern Coffee Cup",
    price: 1400,
    image: GirlCupImage,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Cup</p>

            <h2 className="fw-bold">
              Girl Art Pattern Coffee Cup
            </h2>
