...
import GirlFrame from "../../Images/Girlartcanvas.png";
...
const images = [GirlFrame, GirlFrame];

export default function GirlArtFrame() {
  ...
  const product = {
    id: "frame-002",
    productCode: "GirlArt-Canva-Frame-002",
    name: "Girl Art Canva Frame",
    price: 1000,
    image: GirlFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Girl Art Pattern Canva Frame</h2>
