...
import GirlTshirt from "../../Images/GirlTshirt.png";
...
const images = [GirlTshirt, GirlTshirt];

export default function GirlArtTshirt() {
  ...
  const product = {
    id: "tshirt-002",                 // internal (React/cart)
    productCode: "Girl-Tshirt-002", // business tracking (backend)
    name: "Girl Art Pattern Tshirt",
    price: 1400,
    image: GirlTshirt,
  };
