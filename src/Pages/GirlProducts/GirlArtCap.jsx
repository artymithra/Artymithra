...
import GirlCap from "../../Images/GirlCap.png";
...
const images = [GirlCap, GirlCap];

export default function GirlArtCap() {
  ...
  const product = {
    id: "cap-002",                 // internal (React/cart)
    productCode: "Girl-Cap-002", // business tracking (backend)
    name: "Girl Art Pattern Cap",
    price: 1400,
    image: GirlCap,
  };
