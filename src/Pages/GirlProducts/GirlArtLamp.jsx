...
import GirlLamp from "../../Images/Girlartlamp.png";
...
const images = [GirlLamp, GirlLamp];
const MIN_QTY = 25;

export default function GirlArtLamp() {
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Girl Art Pattern Lamp</h2>
