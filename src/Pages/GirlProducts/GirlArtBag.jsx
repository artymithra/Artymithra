...
import GirlBag from "../../Images/GirlBag.png";
...
const images = [GirlBag, GirlBag];

export default function GirlArtBag() {
  ...
  const product = {
    id: "bag-002",                 // internal (React/cart)
    productCode: "Girl-bag-002", // business tracking (backend)
    name: "Girl Art Pattern Bag",
    price: 600,
    image: GirlBag,
  };
