...
import GirlBottle from "../../Images/GirlBottle.png";
...
const images = [GirlBottle, GirlBottle];

export default function GirlArtBottle() {
  ...
  const product = {
    id: "bottle-002",                 // internal (React/cart)
    productCode: "Girl-bottle-002", // business tracking (backend)
    name: "Girl Art Pattern Bottle",
    price: 1400,
    image: GirlBottle,
  };
