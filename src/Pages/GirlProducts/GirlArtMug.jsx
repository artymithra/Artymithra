...
import GirlMug from "../../Images/GirlMug.png";
...
const images = [GirlMug, GirlMug];

export default function GirlArtMug() {
  ...
  const product = {
    id: "mug-002",                 // internal (React/cart)
    productCode: "Girl-Mug-002", // business tracking (backend)
    name: "Girl Art Pattern Ceramic Mug",
    price: 600,
    image: GirlMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Girl Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
