...
import KrishnarFrame from "../../Images/Krishnancanvas.png";
...
const images = [KrishnarFrame, KrishnarFrame];

export default function KrishnarArtFrame() {
  ...
  const product = {
    id: "frame-009",                 
    productCode: "KrishnarArt-Canva-Frame-009",
    name: "Krishnar Art Canva Frame",
    price: 1000,
    image: KrishnarFrame,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Krishnar Art Pattern Canva Frame
            </h2>
