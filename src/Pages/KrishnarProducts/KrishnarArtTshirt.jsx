...
import KrishnarTshirt from "../../Images/Krishnantshirt.png";
import { useCart } from "../CartContext";
import { useNavigate } from "react-router-dom";
import "../../App.css";
import AppBreadcrumbs from "../AppBreadcrumbs";

const images = [KrishnarTshirt, KrishnarTshirt];

export default function KrishnarArtTshirt() {
  ...
  const product = {
    id: "Tshirt-009",                 
    productCode: "KrishnarArt-Tshirt-009",
    name: "Krishnar Art Tshirt",
    price: 600,
    image: KrishnarTshirt,
  };
