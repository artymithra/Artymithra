...
import KrihnarArtMug from "../../Images/KrishnanMug.png";
...
const images = [KrihnarArtMug, KrihnarArtMug];

export default function KrishnarArtMug() {
  ...
  const product = {
    id: "mug-009",                 
    productCode: "KrishnarArt-Mug-009",
    name: "Krishnar Art Mug",
    price: 600,
    image: KrihnarArtMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Krishnar Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
