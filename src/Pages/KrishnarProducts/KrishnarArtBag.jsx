...
import KrishnarBag from "../../Images/KrishnanBag.png";
...
const images = [KrishnarBag, KrishnarBag];

export default function KrishnarArtBag() {
  ...
  const product = {
    id: "bag-008",                 
    productCode: "KrishnarArt-Bag-009",
    name: "KrishnarArt Art Bag",
    price: 1000,
    image: KrishnarBag,
  };
