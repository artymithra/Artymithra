...
import NatureLamp from "../../Images/Naturelamp.png";
...
const images = [NatureLamp, NatureLamp];
const MIN_QTY = 25;

export default function NatureArtLamp() {
  ...
  const product = {
    id: "lamp-005",
    productCode: "NatureArt-Lamp-005",
    name: "Nature Art Lamp",
    price: 200,
    image: NatureLamp,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Nature Art Pattern Lamp</h2>
