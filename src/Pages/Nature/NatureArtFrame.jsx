...
import NatureFrame from "../../Images/Naturecanvas.png";
...
const images = [NatureFrame, NatureFrame];

export default function NatureArtFrame() {
  ...
  const product = {
    id: "frame-005",
    productCode: "NatureArt-Canva-Frame-005",
    name: "Nature Art Canva Frame",
    price: 1000,
    image: NatureFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Nature Art Pattern Canva Frame</h2>
