...
import NatureCup from "../../Images/NatureCup.png";
...
const images = [NatureCup, NatureCup];

export default function NatureArtCup() {
  ...
  const product = {
    id: "cup-005",                 
    productCode: "NatureArt-CoffeeCup-005",
    name: "Nature Art Cup",
    price: 1400,
    image: NatureCup,
  };
