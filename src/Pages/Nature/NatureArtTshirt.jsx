...
import NatureTshirt from "../../Images/NatureTshirt.png";
...
const images = [NatureTshirt, NatureTshirt];

export default function NatureArtTshirt() {
  ...
  const product = {
    id: "Tshirt-005",                 
    productCode: "NatureArt-Tshirt-005",
    name: "Nature Art Tshirt",
    price: 1400,
    image: NatureTshirt,
  };
