...
import NatureBottle from "../../Images/NatureBottle.png";
...
const images = [NatureBottle, NatureBottle];

export default function NatureArtBottle() {
  ...
  const product = {
    id: "bottle-005",                 
    productCode: "NatureArt-Bottle-005",
    name: "Nature Art Bottle",
    price: 1400,
    image: NatureBottle,
  };
