...
import NatureMug from "../../Images/NatureMug.png";
...
const images = [NatureMug, NatureMug];

export default function NatureArtMug() {
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Nature Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
