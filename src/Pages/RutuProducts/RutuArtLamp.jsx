...
import RutuLamp from "../../Images/Rutulamp.png";
...
const images = [RutuLamp, RutuLamp];
const MIN_QTY = 25;

export default function RutuArtLamp() {
  ...
  const product = {
    id: "lamp-011",
    productCode: "RuturajArt-Lamp-011",
    name: "Ruturaj Art Lamp",
    price: 200,
    image: RutuLamp,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Ruturaj Art Pattern Lamp</h2>
