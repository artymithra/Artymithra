...
import RutuTshirt from "../../Images/Rututshirt.png";
...
const images = [RutuTshirt, RutuTshirt];

export default function RutuArtTshirt() {
  ...
  const product = {
    id: "Tshirt-011",                 
    productCode: "RuturajArt-Tshirt-011",
    name: "Ruturaj Art Tshirt",
    price: 600,
    image: RutuTshirt,
  };
