...
import RutuFrame from "../../Images/Rutucanvas.png";
...
const images = [RutuFrame, RutuFrame];

export default function RutuArtFrame() {
  ...
  const product = {
    id: "frame-011",                 
    productCode: "RuturajArt-Canva-Frame-011",
    name: "Ruturaj Art Canva Frame",
    price: 1000,
    image: RutuFrame,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Ruturaj Art Pattern Canva Frame
            </h2>
