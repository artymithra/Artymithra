...
import RutuMug from "../../Images/Rutumug.png";
import { useCart } from "../CartContext";
import { useNavigate } from "react-router-dom";
import "../../App.css";
import AppBreadcrumbs from "../AppBreadcrumbs";

const images = [RutuMug, RutuMug];

export default function RutuArtMug() {
  ...
  const product = {
    id: "mug-011",                 
    productCode: "RuturajArt-Mug-011",
    name: "Ruturaj Art Mug",
    price: 600,
    image: RutuMug,
  };
        ...
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">
              Ruturaj Art Pattern Ceramic  Mug for Tea & Coffee Lovers
            </h2>
