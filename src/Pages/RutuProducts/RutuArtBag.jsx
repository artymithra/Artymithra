...
import RutuBag from "../../Images/RutuBag.png";
...
const images = [RutuBag, RutuBag];

export default function RutuArtBag() {
  ...
  const product = {
    id: "bag-011",                 
    productCode: "RuturajArt-Bag-011",
    name: "Ruturaj Art Bag",
    price: 1000,
    image: RutuBag,
  };
