...
import LionCap from "../../Images/LionCap.png";
...
const images = [LionCap, LionCap];

export default function LionArtCap() {
  ...
  const product = {
    id: "cap-001",                 // internal (React/cart)
    productCode: "LionArt-Cap-001", // business tracking (backend)
    name: "Lion Art Pattern Cap",
    price: 1400,
    image: LionCap,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Cap</p>

            <h2 className="fw-bold">
              Lion Art Pattern Cap
            </h2>
