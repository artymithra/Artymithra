...
import LionMug from "../../Images/LionMug.png";
...
const images = [LionMug, LionMug];

export default function LionArtMug() {
  ...
  const product = {
    id: "mug-001",                 // internal (React/cart)
    productCode: "LionArt-Mug-001", // business tracking (backend)
    name: "Lion Art Pattern Ceramic Mug",
    price: 1400,
    image: LionMug,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Mug</p>

            <h2 className="fw-bold">
              Lion Art Pattern Ceramic Mug for Tea & Coffee Lovers
            </h2>
