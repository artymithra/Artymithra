...
import LionBottle from "../../Images/LionBottle.png";
...
const images = [LionBottle, LionBottle];

export default function LionArtBottle() {
  ...
  const product = {
    id: "bottle-001",                 // internal (React/cart)
    productCode: "LionArt-Bottle-001", // business tracking (backend)
    name: "Lion Art Pattern Bottle",
    price: 1400,
    image: LionBottle,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Bottle</p>

            <h2 className="fw-bold">
              Lion Art Pattern Bottle
            </h2>
