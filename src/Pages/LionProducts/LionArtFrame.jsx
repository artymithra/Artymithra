...
import LionFrame from "../../Images/lioncanvas.png";
...
const images = [LionFrame, LionFrame];

export default function LionArtFrame() {
  ...
  const product = {
    id: "frame-001",
    productCode: "LionArt-Canva-Frame-001",
    name: "Lion Art Canva Frame",
    price: 1000,
    image: LionFrame,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            ...
            <h2 className="fw-bold">Lion Art Pattern Canva Frame</h2>
