...
import LionTshirt from "../../Images/LionTshirt.png";
...
const images = [LionTshirt, LionTshirt];

export default function LionArtTshirt() {
  ...
  const product = {
    id: "tshirt-001",                 // internal (React/cart)
    productCode: "LionArt-Tshirt-001", // business tracking (backend)
    name: "Lion Art Pattern Tshirt",
    price: 600,
    image: LionTshirt,
  };
