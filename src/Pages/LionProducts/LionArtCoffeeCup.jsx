...
import LionCoffeeCup from "../../Images/LionCoffeeCup.png";
...
const images = [LionCoffeeCup, LionCoffeeCup];

export default function LionCofffeCup() {
  ...
  const product = {
    id: "coffeecup-001",                 // internal (React/cart)
    productCode: "LionArt-CoffeeCup-001", // business tracking (backend)
    name: "Lion Art Pattern Coffee Cup",
    price: 1400,
    image: LionCoffeeCup,
  };
      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-12 col-lg-6 mt-4 mt-lg-0">
            <p className="fw-bold mb-1">Coffee Cup</p>

            <h2 className="fw-bold">
              Lion Art Pattern Coffee Cup
            </h2>
